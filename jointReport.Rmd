...
compareValues(reportedValue = -2.8, obtainedValue = diff_Shock_NoShock)

#2. Shock Desc vs. No-Shock Desc
diff_Desc = mean_ShockDesc - mean_NoShockDesc
compareValues(reportedValue = -1, obtainedValue = diff_Desc)

#3. Shock Experience vs. No-Shock Experience
diff_Exp = mean_ShockExp - mean_NoShockExp
compareValues(reportedValue = -4.5, obtainedValue = diff_Exp)

#4. Shock Experience vs. Shock Description
diff_ShockExpDesc = mean_ShockExp - mean_ShockDesc
compareValues(reportedValue = -14.7, obtainedValue = diff_ShockExpDesc)
...
![Screenshot of footnote 2 where this formula is detailed.](confidenceIntervalFormula.png)

#1. Shock vs. No-Shock
# get degrees of freedom (# of participants 1st group + # of participants 2nd group - 2)
df_1 = 100 + 100 - 2 

# get critical t-value using this df
critical_t_1 = qt(.975,df_1) # .975 = 1 - alpha (.05)/2
...
a_1 = sqrt((1/100)+(1/100)) # next argument
